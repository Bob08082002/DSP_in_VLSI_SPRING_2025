...
HD_PWD='C:/Users/zhanggenqi/Desktop/DSP_in_VLSI/HW1/VIVADO/DSP_in_VLSI_HW1_v1/DSP_in_VLSI_HW1_v1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SelectTopK.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SelectTopK.tcl
