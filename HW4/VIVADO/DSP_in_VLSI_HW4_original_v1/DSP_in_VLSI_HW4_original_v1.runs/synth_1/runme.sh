...
HD_PWD='C:/Users/zhanggenqi/Desktop/DSP_in_VLSI/HW4/VIVADO/DSP_in_VLSI_HW4_original_v1/DSP_in_VLSI_HW4_original_v1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CORDIC_original.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CORDIC_original.tcl
