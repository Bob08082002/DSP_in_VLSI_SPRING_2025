...
HD_PWD='C:/Users/zhanggenqi/Desktop/DSP_in_VLSI/HW3/VIVADO/DSP_in_VLSI_HW3_v2/DSP_in_VLSI_HW3_v2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log parabolic_interpolator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source parabolic_interpolator.tcl
